...
class VisualizacaoLivroFragment : Fragment() {

    private var _binding: FragmentVisualizacaoLivroBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVisualizacaoLivroBinding.inflate(inflater, container, false)
