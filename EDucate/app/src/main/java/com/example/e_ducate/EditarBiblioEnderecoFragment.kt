...
class EditarBiblioEnderecoFragment : Fragment() {
    private var _binding: FragmentEditarBiblioEnderecoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditarBiblioEnderecoBinding.inflate(inflater, container, false)
