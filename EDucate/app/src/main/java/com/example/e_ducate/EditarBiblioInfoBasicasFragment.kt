...
class EditarBiblioInfoBasicasFragment : Fragment() {
    private var _binding: FragmentEditarBiblioInfoBasicasBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditarBiblioInfoBasicasBinding.inflate(inflater, container, false)
